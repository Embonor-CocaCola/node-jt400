...
describe('PGM', () => {
    it('should run rpg program', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('should run GETNETFG', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('should run pgm with datastructure param', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('should run pgm with datastructure param with columns format', () => __awaiter(this, void 0, void 0, function* () {
        const tstDs = db_1.jt400.defineProgram({
            programName: 'TST_DS',
            paramsSchema: [
                {
