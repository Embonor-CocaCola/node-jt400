...
describe('ifs', () => {
    ...
    it('should get file metadata', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('should get metadata for file that does not exists', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('should pipe image', done => {
        ...
        rs.pipe(ws).on('finish', () => {
            ...
            streamEqual(oldImage, newImage, (error, equal) => {
                chai_1.expect(error).to.be.equal(null);
